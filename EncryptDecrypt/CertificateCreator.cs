...
/// <summary>
/// A class for creating X509 certificates in .NET. 
/// </summary>
/// <remarks>
/// Derived from work by Doug E. Cook, http://blogs.msdn.com/b/dcook/archive/2008/11/25/creating-a-self-signed-certificate-in-c.aspx
/// </remarks>
        ...
        SecureString password)
    {
        ...
        try
        {
            ...
            Check(NativeMethods.CryptGenKey(
                providerContext,
                1, // AT_KEYEXCHANGE    
                1 | (KeyLength << 16), // CRYPT_EXPORTABLE
                out cryptKey));
